...
var require_web_outgoing = __commonJS((exports, module) => {
  ...
  module.exports = {
    ...
    writeHeaders: function writeHeaders(req, res, proxyRes, options) {
      var { cookieDomainRewrite: rewriteCookieDomainConfig, cookiePathRewrite: rewriteCookiePathConfig, preserveHeaderKeyCase } = options, rawHeaderKeyMap, setHeader = function(key2, header) {
        if (header == undefined)
          return;
...
var require_web_incoming = __commonJS((exports, module) => {
...
var require_http_proxy = __commonJS((exports, module) => {
...
var require_http_proxy2 = __commonJS((exports, module) => {
...
var require_errors = __commonJS((exports) => {
  ...
  (function(ERRORS2) {
    ...
    ERRORS2["ERR_CONTEXT_MATCHER_GENERIC"] = '[HPM] Invalid context. Expecting something like: "/api" or ["/api", "/ajax"]';
    ERRORS2["ERR_CONTEXT_MATCHER_INVALID_ARRAY"] = '[HPM] Invalid context. Expecting something like: ["/api", "/ajax"] or ["/api/**", "!**.html"]';
...
var require_logger = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.getArrow = exports.getInstance = undefined;
  var util = __require("util");
  var loggerInstance;
  var defaultProvider = {
    log: console.log,
...
var require_config_factory = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_context_matcher = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require__handlers = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.getHandlers = exports.init = undefined;
  var logger_1 = require_logger();
  var logger = (0, logger_1.getInstance)();
...
var require_path_rewriter = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.createPathRewriter = undefined;
  var isPlainObj = require_is_plain_obj();
  var errors_1 = require_errors();
  var logger_1 = require_logger();
  var logger = (0, logger_1.getInstance)();
...
var require_http_proxy_middleware = __commonJS((exports) => {
  ...
  var config_factory_1 = require_config_factory();
  var contextMatcher = require_context_matcher();
  var handlers = require__handlers();
  var logger_1 = require_logger();
  ...
  class HttpProxyMiddleware {
    constructor(context, opts) {
      ...
      this.middleware = async (req, res, next) => {
        ...
        const server = (_b = (_a = req.socket) !== null && _a !== undefined ? _a : req.connection) === null || _b === undefined ? undefined : _b.server;
      ...
      this.shouldProxy = (context2, req) => {
        try {
          ...
          return contextMatcher.match(context2, path, req);
        } catch (error) {
      ...
      this.logError = (err, req, res, target) => {
        var _a;
        const hostname = ((_a = req.headers) === null || _a === undefined ? undefined : _a.host) || req.hostname || req.host;
        const requestHref = `${hostname}${req.url}`;
        const targetHref = `${target === null || target === undefined ? undefined : target.href}`;
...
var require_response_interceptor = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.responseInterceptor = undefined;
  var zlib = __require("zlib");
...
var require_fix_request_body = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.fixRequestBody = undefined;
  var querystring = __require("querystring");
...
var require_public = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.fixRequestBody = exports.responseInterceptor = undefined;
...
var require_dist = __commonJS((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.createProxyMiddleware = undefined;
...
// helpers/pinger.ts
var alreadyLivePorts = new Set;
var isPortLivePingChecker = async (subdomains) => {
  ...
  Object.keys(subdomains).forEach((subdomain) => {
    subdomains[subdomain].forEach((conf, path) => {
      if (conf.port) {
        tasks.push(checkPort(conf.port).then((isAlive) => {
          if (isAlive) {
...
// helpers/table-renderer.ts
var renderScreen = (rl) => (PORT, subdomains) => {
  console.clear();
...
`);
  ...
  if (!isAnyPathMappings) {
    ...
    console.table(Array.from(Object.keys(subdomains)).map((subd) => {
...
var fileFlagIndex = args.findIndex((a) => a === "-f");
var configFile = fileFlagIndex >= 0 ? args[fileFlagIndex + 1] : "port2port.json";
var hostPort = 4000;
...
var createOrUpdateProxies = (cacheKey, target, pathRewrite) => {
...
function deleteProxy(app, routePath) {
...
rl.question(`Enter hosting port (default ${hostPort}): `, (answer) => {
  ...
  app.use((req, res, next) => {
    ...
    const matchedEntry = [...subdomains[subdomain].entries()].sort((a, b) => b[0].length - a[0].length).find(([path2]) => req.path.startsWith(path2));
    if (!matchedEntry) {
    ...
    if (conf.target) {
      ...
      const newPath = targetUrl.pathname.endsWith("/") ? targetUrl.pathname.slice(0, -1) : targetUrl.pathname;
